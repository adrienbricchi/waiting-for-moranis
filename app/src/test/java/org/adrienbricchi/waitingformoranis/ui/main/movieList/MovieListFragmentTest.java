...
public class MovieListFragmentTest {
    ...
    class NewInstanceTests {
        ...
        @Test
        public void shouldReturnMovieListFragmentInstance() {

            MovieListFragment fragment = MovieListFragment.newInstance();

            assertInstanceOf(MovieListFragment.class, fragment);
        }
        ...
        public void shouldReturnNewInstanceOnEachCall() {
            ...
            MovieListFragment fragment1 = MovieListFragment.newInstance();
            MovieListFragment fragment2 = MovieListFragment.newInstance();
